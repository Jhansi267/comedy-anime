  ...
  const episodes = [
    {
      ...
      votes: 512,
      details:
        "What started as a simple office prank turned into a full-blown racing tournament during lunch breaks. Employees customized their chairs with makeshift engines and competed in hallway races.",
      badgeText: "Trending",
    },
    {
      id: 2,
      ...
      votes: 421,
      details:
        "Someone replaced all the keycaps with confetti poppers. Every time employees typed, colorful paper explosions covered their desks. Productivity dropped but morale skyrocketed.",
      badgeText: "Popular",
    },
    {
      id: 3,
      ...
      votes: 687,
      details:
        "All the coffee in the office was secretly replaced with decaf for a week. The reactions ranged from confusion to existential crisis as employees questioned their life choices.",
    ...
    },
    {
      ...
      votes: 389,
      details:
        "Someone installed tiny motors in all the office mice, making them randomly move on their own. Employees thought their computers were haunted or they were working too hard.",
      badgeText: "Funny",
    },
    {
      id: 5,
      ...
      votes: 356,
      details:
        "Every computer monitor in the office was set to display upside down. Some employees tried to work like this for hours before realizing they could just rotate the display settings.",
      badgeText: "New",
    },
    {
      id: 6,
      ...
      votes: 498,
      details:
        "Someone triggered a fake fire drill during the busiest work hour. The best part was watching executives in suits sprint down the emergency stairs clutching their laptops.",
      badgeText: "Trending",
    },
    {
      id: 7,
      ...
      votes: 543,
      details:
        "Overnight, someone covered every blank wall space with intricate sticky note mosaics depicting famous artworks and office inside jokes.",
      badgeText: "Fan Favorite",
    },
    {
      id: 8,
      ...
      votes: 412,
      details:
        "Employees kept finding strange comments and edits in their documents from an unknown collaborator. The messages ranged from helpful suggestions to absurd jokes.",
      badgeText: "Popular",
    },
    {
      id: 9,
      ...
      votes: 467,
      details:
        "Someone stayed late and completely rearranged all the office furniture. The next morning, executives found themselves at interns' desks and vice versa.",
      badgeText: "Funny",
    },
    {
      id: 10,
      ...
      votes: 521,
      details:
        "A clever hack made the office printer spit out endless copies of ridiculous memes. The IT department still hasn't figured out how it was done.",
      badgeText: "Trending",
    },
  ];
