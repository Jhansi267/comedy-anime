  ...
  const captureMeme = async () => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message:
          "Couldn't create meme due to security restrictions. Try using a video from the same domain.",
        severity: "error",
      });
      setCanCapture(false);
    }
        ...
        {!isMobile && (
          ...
          >
            <Button
              ...
              disabled={!canCapture}
              startIcon={
                <Screenshot fontSize={isMobile ? "small" : "medium"} />
              }
              sx={{
                color: "white",
                "&:active": { animation: `${wiggle} 0.3s` },
            ...
            <Button
              ...
              startIcon={
                <SlowMotionVideo fontSize={isMobile ? "small" : "medium"} />
              }
              sx={{
