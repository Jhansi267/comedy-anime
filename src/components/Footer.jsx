        ...
        <div className="row pt-5">
          <div className="col-12 col-sm-12 col-md-4 col-lg-4">
            <ul style={{ listStyle: "none" }}>
              ...
              <li className="mb-3">
                Our LOL OTT platform may cause uncontrollable laughter.
              </li>
              <li className="mb-3">
                {" "}
                Each genre comes with its own special effects from romantic
                cherry blossoms that actually hit you in the face to battle
                scenes that make your phone vibrate!.
              </li>
