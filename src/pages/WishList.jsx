...
const WishList = () => {
  ...
  const [episodes, setEpisodes] = useState([
    ...
    },
    {
      ...
      votes: 378,
      badgeText: "Funny",
      details: "The annual music recital turned chaotic when every chair had a hidden surprise. As the orchestra performs a serious classical piece, the synchronized whoopee cushion chorus steals the show. The percussion section's increasingly creative attempts to cover the sounds (including cymbal crashes after every toot) makes this episode unforgettable."
    },
    {
      id: 5,
                  ...
                  <div style={{
                    ...
                    <div style={styles.hoverState}>
                      ...
                      <div style={styles.cardActions} className="d-flex me-auto">
                        <IconButton onClick={() => nav('/WatchEpisode')}>
                          <FaPlay size={25} style={{ color: "orange" }} />
                        </IconButton>
                        <IconButton onClick={() => handleDelete(episode.id)}>
                          <DeleteIcon fontSize="large" style={{ color: "orange" }} />
                        </IconButton>
                      </div>
                    </div>
                  </div>
